...
void ImGui::ShowTestWindow(bool* p_opened)
{
    ...
    if (ImGui::CollapsingHeader("Layout"))
    {
        ...
        {
            ImGui::Text("Without boraaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaader");
            static int line = 50;
            ...
            ImGui::Text("With borxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxder");
            ImGui::Columns(2);
            for (int i = 0; i < 100; i++)
            {
                if (i == 50)
                ...
                for (int i = 0; i < 8; i++)
                {
                    ...
                    else
                    {
                        ...
                        if (i >= 5)
							...
							//ImGui::Button("AAA", ImVec2(100, 100));
						}
                        ImGui::PopItemWidth();
                        ImGui::NextColumn();
                    }
